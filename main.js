...
const mainStationList = new Set(["基隆", "七堵", "汐止", "松山", "臺北", "臺北_環島", "板橋", "樹林", "鶯歌", "桃園", "中壢", "北湖", "六家", "竹東", "內灣", "新竹", "竹南", "通霄", "大甲", "沙鹿", "苗栗", "豐原", "臺中", "新烏日", "彰化", "員林", "田中", "二水", "車埕", "斗六", "斗南", "嘉義", "新營", "善化", "永康", "臺南", "中洲", "沙崙", "岡山", "楠梓", "新左營", "高雄", "鳳山", "屏東", "潮州", "枋寮", "大武", "臺東", "關山", "池上", "玉里", "瑞穗", "光復", "壽豐", "花蓮", "新城", "和平", "東澳", "蘇澳新", "羅東", "宜蘭", "頭城", "福隆", "雙溪", "十分", "菁桐", "瑞芳", "八斗子"]);
